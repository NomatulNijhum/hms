...
class TblPostController extends Controller
{
   ...
   {
     return view('BloodBank.badmin_login');
   }
   ...
   public function login_admin(Request $request)
    ...
    {
      return view('BloodBank.badmin_profile');
    }
    ...
    {
       return view('BloodBank.editbadmin');
    }
    ...
    public function all_donar()
    {
      $donor_info=DB::table('tbl_user')
                   ...
                   ->get();
      $show_donor=view('BloodBank.all_donar')
                      ->with('donor_info',$donor_info);

     return view('welcome')
            ->with('BloodBank.all_donar',$show_donor);
    }
    ...
    public function all_user()
    {
      $donor_info=DB::table('tbl_user')
                   ...
                   ->get();
      $show_donor=view('BloodBank.all_buser')
                      ->with('donor_info',$donor_info);

     return view('welcome')
            ->with('BloodBank.all_buser',$show_donor);
    }
    ...
    {
       return view('BloodBank.badmin_reg');
    }
